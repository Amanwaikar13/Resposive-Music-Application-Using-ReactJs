...
import OrderDetails from './Assignment/orderDetails';
import Pizza from './Assignment/pizza';
import Menu from './Assignment/menu'
import Soup from './Assignment/soup';
import StaterVeg from './Assignment/StaterVeg';
import Home from './Assignment/Home';
import Details from './Assignment/detail';
import NavigationBar from './Assignment/Navbar';
...
<Routes>
  ...
  <Route exact  path="/stater-veg" element={<StaterVeg />} />
  <Route exact  path="/orderDetails" element={<OrderDetails />} />
  <Route exact  path="/soup" element={<Soup />} />
  <Route exact  path="/pizza" element={<Pizza />} />
  <Route exact  path="/stater-nonveg" element={<OrderDetails />} />
  <Route exact  path="/main-course" element={<OrderDetails />} />
  <Route exact  path="/burger" element={<OrderDetails />} />
  <Route exact  path="/rum" element={<OrderDetails />} />
...
//     newCards.splice(cardIndex + 1, 0, newCards.length);
//     setCards(newCards);
//   }
...
//       <div className="row">
//         {cards.map((cardIndex) => (
//           <div key={cardIndex} className="col-md-6">
//             <Card onClick={() => handleCardClick(cardIndex)} />
//           </div>
//         ))}
//       </div>
//     </div>
